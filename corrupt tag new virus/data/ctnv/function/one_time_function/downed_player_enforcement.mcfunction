...
# id 1
execute as @a[team=runners,scores={player_ID=1}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_1_shulker"]}
...
# id 2
execute as @a[team=runners,scores={player_ID=2}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_2_shulker"]}
...
# id 3
execute as @a[team=runners,scores={player_ID=3}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_3_shulker"]}
...
# id 4
execute as @a[team=runners,scores={player_ID=4}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_4_shulker"]}
...
# id 5
execute as @a[team=runners,scores={player_ID=5}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_5_shulker"]}
...
# id 6
execute as @a[team=runners,scores={player_ID=6}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_6_shulker"]}
...
# id 7
execute as @a[team=runners,scores={player_ID=7}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_7_shulker"]}
...
# id 8
execute as @a[team=runners,scores={player_ID=8}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_8_shulker"]}
...
# id 9
execute as @a[team=runners,scores={player_ID=9}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_9_shulker"]}
...
# id 10
execute as @a[team=runners,scores={player_ID=10}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_10_shulker"]}
...
# id 11
execute as @a[team=runners,scores={player_ID=11}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_11_shulker"]}
...
# id 12
execute as @a[team=runners,scores={player_ID=12}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_12_shulker"]}
...
# id 13
execute as @a[team=runners,scores={player_ID=13}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_13_shulker"]}
...
# id 14
execute as @a[team=runners,scores={player_ID=14}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_14_shulker"]}
...
# id 15
execute as @a[team=runners,scores={player_ID=15}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_15_shulker"]}
...
# id 16
execute as @a[team=runners,scores={player_ID=16}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_16_shulker"]}
...
# id 17
execute as @a[team=runners,scores={player_ID=17}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_17_shulker"]}
...
# id 18
execute as @a[team=runners,scores={player_ID=18}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_18_shulker"]}
...
# id 19
execute as @a[team=runners,scores={player_ID=19}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_19_shulker"]}
...
# id 20
execute as @a[team=runners,scores={player_ID=20}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_20_shulker"]}
...
# id 21
execute as @a[team=runners,scores={player_ID=21}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_21_shulker"]}
...
# id 22
execute as @a[team=runners,scores={player_ID=22}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_22_shulker"]}
...
# id 23
execute as @a[team=runners,scores={player_ID=23}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_23_shulker"]}
...
# id 24
execute as @a[team=runners,scores={player_ID=24}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_24_shulker"]}
...
# id 25
execute as @a[team=runners,scores={player_ID=25}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_25_shulker"]}
...
# id 26
execute as @a[team=runners,scores={player_ID=26}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_26_shulker"]}
...
# id 27
execute as @a[team=runners,scores={player_ID=27}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_27_shulker"]}
...
# id 28
execute as @a[team=runners,scores={player_ID=28}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_28_shulker"]}
...
# id 29
execute as @a[team=runners,scores={player_ID=29}] if score @s health matches ..0 at @s if score @s downed matches 1 run summon shulker ~ ~ ~ {Invulnerable:1b,NoAI:1b,Silent:1b,Tags:["downed_player","ID_29_shulker"]}
