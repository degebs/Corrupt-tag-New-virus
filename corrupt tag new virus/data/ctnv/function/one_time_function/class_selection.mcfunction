...
# Authority+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# prevent accidental instant selection
execute as @a if score countdown time matches 29 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] run item replace entity @s inventory.26 with shield[tooltip_display={hidden_components:["minecraft:banner_patterns"]},banner_patterns=[{pattern:gradient_up,color:magenta},{pattern:gradient_up,color:black},{pattern:skull,color:black},{pattern:triangles_top,color:black},{pattern:triangle_bottom,color:black}],base_color=purple,custom_name=[{"text":"Authority","italic":false,"color":"#c800ff"}],lore=[[{"text":"=== 15% corruption ===","italic":false,"color":"dark_purple"}],[{"text":"-GRAVITY PULL","italic":false,"color":"white"}],[{"text":"- Pulls Down ALL runners for 5 seconds","italic":false,"color":"white"}],[{"text":"=== 50% corruption ===","italic":false,"color":"dark_purple"}],[{"text":"- gain a \"reveal player modulator\"","italic":false,"color":"white"}],[{"text":"- it makes all runners glow until destroyed ","italic":false,"color":"white"}],[{"text":"=== 90% corruption ===","italic":false,"color":"dark_purple"}],[{"text":"- SECURITY","italic":false,"color":"white"}],[{"text":"- spawns an small army of guards after the runners","italic":false,"color":"yellow"}],[{"text":"-----------------------","italic":false,"color":"dark_purple"}],[{"text":"\"I’ve heard enough, deadly force authorized!\"","italic":false,"color":"red"},{"text":" ","italic":false,"color":"red"}]]]
# set the cooldown
execute as @a at @s if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] if score @s class_selection_cooldown matches 0 run scoreboard players set @s class_selection_cooldown 3

# automatically close the player inventory on click
execute as @a at @s if score countdown time matches ..28 if score @s class_selection_cooldown matches 3 run fill ~ ~1 ~ ~ ~1 ~ nether_portal replace air
execute as @a at @s if score countdown time matches ..28 if score @s class_selection_cooldown matches 2 run fill ~1 ~1 ~1 ~-1 ~-1 ~-1 air replace nether_portal
# select class
execute as @a if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] run clear @s shield
execute as @a if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] run kill @e[type=item,nbt={Item:{id:"minecraft:shield"}}]
# selection
execute as @a if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] run scoreboard players set @s evil_class 8
execute as @a if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] run tellraw @a [{"color":"gold","selector":"@s"}," ",{"text":"picked the","color":"white"}," ",{"text":"Authority","color":"dark_purple"}," ",{"text":"Corrupted class","color":"white"}]
execute as @a if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] run playsound minecraft:block.sculk_shrieker.place block @a ~ ~ ~ 1 1.7 1
execute as @a if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:shield",Slot:35b}]}] run item replace entity @s inventory.26 with shield[tooltip_display={hidden_components:["minecraft:banner_patterns"]},banner_patterns=[{pattern:gradient_up,color:magenta},{pattern:gradient_up,color:black},{pattern:skull,color:black},{pattern:triangles_top,color:black},{pattern:triangle_bottom,color:black}],base_color=purple,custom_name=[{"text":"Authority","italic":false,"color":"#c800ff"}],lore=[[{"text":"=== 15% corruption ===","italic":false,"color":"dark_purple"}],[{"text":"-GRAVITY PULL","italic":false,"color":"white"}],[{"text":"- Pulls Down ALL runners for 5 seconds","italic":false,"color":"white"}],[{"text":"=== 50% corruption ===","italic":false,"color":"dark_purple"}],[{"text":"- gain a \"reveal player modulator\"","italic":false,"color":"white"}],[{"text":"- it makes all runners glow until destroyed ","italic":false,"color":"white"}],[{"text":"=== 90% corruption ===","italic":false,"color":"dark_purple"}],[{"text":"- SECURITY","italic":false,"color":"white"}],[{"text":"- spawns an small army of guards after the runners","italic":false,"color":"yellow"}],[{"text":"-----------------------","italic":false,"color":"dark_purple"}],[{"text":"\"I’ve heard enough, deadly force authorized!\"","italic":false,"color":"red"},{"text":" ","italic":false,"color":"red"}]]]