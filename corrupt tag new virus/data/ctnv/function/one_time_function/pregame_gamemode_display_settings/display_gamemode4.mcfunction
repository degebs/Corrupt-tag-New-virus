...
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 0 run scoreboard players set COC_difficulty_EASY unified_tag_settings 1
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 0 run scoreboard players reset COC_difficulty_HARD unified_tag_settings
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 0 run scoreboard players display name COC_difficulty_EASY unified_tag_settings {"text":"Difficulty: ","color":"dark_red","bold":true,"extra":[{"text":"[EASY]","color":"yellow"}]}
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 0 run scoreboard players display numberformat COC_difficulty_EASY unified_tag_settings blank

execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 1 run scoreboard players set COC_difficulty_MEDIUM unified_tag_settings 1
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 1 run scoreboard players reset COC_difficulty_EASY unified_tag_settings
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 1 run scoreboard players reset COC_difficulty_HARD unified_tag_settings
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 1 run scoreboard players display name COC_difficulty_MEDIUM unified_tag_settings {"text":"Difficulty: ","color":"dark_red","bold":true,"extra":[{"text":"[MEDIUM]","color":"yellow"}]}
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 1 run scoreboard players display numberformat COC_difficulty_MEDIUM unified_tag_settings blank

execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 2 run scoreboard players set COC_difficulty_HARD unified_tag_settings 1
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 2 run scoreboard players reset COC_difficulty_EASY unified_tag_settings
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 2 run scoreboard players reset COC_difficulty_MEDIUM unified_tag_settings
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 2 run scoreboard players display name COC_difficulty_HARD unified_tag_settings {"text":"Difficulty: ","color":"dark_red","bold":true,"extra":[{"text":"[HARD]","color":"yellow"}]}
execute if score @a[team=party_lead,limit=1] ST____COC_difuculty matches 2 run scoreboard players display numberformat COC_difficulty_HARD unified_tag_settings blank
