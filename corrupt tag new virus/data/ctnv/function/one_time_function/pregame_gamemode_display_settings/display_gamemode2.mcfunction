...
# the super speed
execute if score setting ST____super_speed matches 0 run scoreboard players set super_speed_OFF unified_tag_settings 1
execute if score setting ST____super_speed matches 0 run scoreboard players reset super_speed_ON unified_tag_settings
execute if score setting ST____super_speed matches 0 run scoreboard players display name super_speed_OFF unified_tag_settings {"text":"Super Speed: ","color":"dark_aqua","bold":true,"extra":[{"text":"[OFF]","color":"yellow"}]}
execute if score setting ST____super_speed matches 0 run scoreboard players display numberformat super_speed_OFF unified_tag_settings blank
execute if score setting ST____super_speed matches 1 run scoreboard players set super_speed_ON unified_tag_settings 1
