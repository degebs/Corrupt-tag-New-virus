...
#5
execute if score rng brewinator_rng matches 31..40 run give @p[team=corrupted] splash_potion[potion_contents={custom_color:16711815,custom_effects:[{id:raid_omen,duration:400}]},custom_name=[{"text":"Distilled Corruption","italic":false}],lore=[[{"text":"WILL INCREASE CORRUPTION","italic":false}]],rarity=uncommon]
#6
execute if score rng brewinator_rng matches 41..50 run give @p[team=corrupted] splash_potion[potion_contents={custom_color:4522119,custom_effects:[{id:raid_omen,duration:300,amplifier:1},{id:poison,duration:30,amplifier:1}]},custom_name=[{"text":"Acidic Corruption Solution","italic":false}],lore=[[{"text":"WILL INCREASE CORRUPTION","italic":false}]],rarity=uncommon]
#7
