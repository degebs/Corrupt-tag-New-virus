...
#| $$  | $$| $$| $$  | $$| $$_____/       /$$__  $$| $$  | $$| $$  | $$      | $$      | $$_____/ /$$__  $$| $$  | $$            | $$
#| $$  | $$| $$|  $$$$$$$|  $$$$$$$      |  $$$$$$$| $$  | $$|  $$$$$$$      | $$      |  $$$$$$$|  $$$$$$$| $$$$$$$/            | $$
#|__/  |__/|__/ \_______/ \_______/       \_______/|__/  |__/ \_______/      |__/       \_______/ \_______/| $$____/             |__/
#                                                                                                          | $$                      
#                                                                                                          | $$                      
#                                                                                                          |__/

# the main differance between this game mode and the normal game is that its basically hide and seek.
# if a runner gets tagged they do NOT be come corrupted, they just immediately die.
# and they can all win if the corrupted gets too currupted and dies
#most of the code will be coppied over from the normal game mode, but some things will be changed.
#===============================================================================================================
# defeat classs specific calling cards

execute as @a[scores={class=-1},team=dead] at @s run advancement grant @a[team=corrupted] only ctnv:corrupt_tag/medic_death
execute as @a[scores={class=-2},team=dead] at @s run advancement grant @a[team=corrupted] only ctnv:corrupt_tag/archer_death
execute as @a[scores={class=-3},team=dead] at @s run advancement grant @a[team=corrupted] only ctnv:corrupt_tag/bulk_death
execute as @a[scores={class=-4},team=dead] at @s run advancement grant @a[team=corrupted] only ctnv:corrupt_tag/assassin_death
...
# this is done only for the corrupted
execute as @a[team=corrupted] if score @s corruption matches 0..9 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ██████████","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 9..19 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" █","color":"dark_purple"},{"text":"█████████","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 20..29 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ██","color":"dark_purple"},{"text":"████████","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 30..39 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ███","color":"dark_purple"},{"text":"███████","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 40..49 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ████","color":"dark_purple"},{"text":"██████","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 50..59 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" █████","color":"dark_purple"},{"text":"█████","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 60..69 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ▓█████","color":"dark_purple"},{"text":"████","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 70..79 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ▓▓█████","color":"dark_purple"},{"text":"███","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 80..89 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ▓▓▓█████","color":"dark_purple"},{"text":"██","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 90..99 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ▓▓▓▓█████","color":"dark_purple"},{"text":"█","color":"white"}]
execute as @a[team=corrupted] if score @s corruption matches 100.. run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            ","color":"gray"},{"score":{"name":"@s","objective":"corruption"}},{"text":"% corrupt","color":"dark_purple"},{"text":" ▒▓▓▓▓█████","color":"dark_purple"}]

# the runners get a different overlay
scoreboard players set @a[team=runners] runners_alive 0
execute as @a[team=runners,scores={health=1..}] run scoreboard players add @a[team=runners] runners_alive 1
scoreboard players operation @a[team=runners,scores={health=1..}] runners_alive = @a[team=runners] runners_alive
# this new overlay will show them how many runners are alive, and who the corrupted is
execute as @a[team=runners] if score @s corruption matches 0..9 run title @s actionbar ["",{"text":"Corrupted: ","color":"red"},{"selector":"@a[team=corrupted,limit=1]"},{"text":"                            "},{"text":"Runners Alive: ","color":"green"},{"score":{"name":"*","objective":"runners_alive"}}]
...
# 5 = The Knight
# 6 = the Dark Star
execute as @a[scores={class=1},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/medic
execute as @a[scores={class=2},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/archer
execute as @a[scores={class=3},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/bulk
execute as @a[scores={class=4},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/assassin
execute as @a[scores={class=5},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/stunman
execute as @a[scores={class=6},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/fisherman
execute as @a[scores={class=7},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/miner
execute as @a[scores={class=8},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/merchant
execute as @a[scores={class=9},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/farmer
execute as @a[scores={class=10},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/trickster
execute as @a[scores={class=11},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/spaceman
execute as @a[scores={class=12},team=runners] if score setting ST____enable_runner_classes matches 1 run function ctnv:classes/runners/pirate
...
#==================================================================================================================================
# every runner shall be given a chorus frurit to teleport them to a fellow runner
# check to see if the teleport fruit has been dropped.
execute as @a[team=runners] if score @a[team=corrupted,limit=1] corruption_stun matches 1 if score tick time matches 7 run give @s chorus_fruit
# if there is only 1 runner take away the chorus fruit
execute if score @a[team=runners,limit=1] runners_alive matches 1 run clear @a[team=runners] chorus_fruit
# teleport the runner to a fellow runner with the "corruption_fruit_teleport" scoreboard variable
execute as @a[team=runners] if score @s chorus_fruit_runners matches 1 run tp @s @a[team=runners,limit=1,sort=random]
execute as @a[team=runners] if score @s chorus_fruit_runners matches 2.. run tp @s @a[team=runners,limit=1,sort=nearest]

# add one to the variable so that the TP ABSOLUTLY happens
execute as @a[team=runners] if score @s chorus_fruit_runners matches 1.. run scoreboard players add @s chorus_fruit_runners 1
# reset the varible
execute as @a[team=runners] if score @s chorus_fruit_runners matches 5 run scoreboard players reset @a chorus_fruit_runners
#==================================================================================================================================
...
# we need a clock to keep track of time internally so that we may give the corrupted one his corruption ONLY once
scoreboard players add hide_and_reap_time playtime 1

# the killing logic. if the runner gets hit and there health reaches 0, they die. if the setting "downed on kill" is 1, they will be downed instead of killed
execute if score setting ST____downed_on_kill matches 0 run function ctnv:alternate_gamemode_functions/hide_and_reap_kill
execute if score setting ST____downed_on_kill matches 1 unless score hide_and_reap_time playtime matches 0..50 run function ctnv:alternate_gamemode_functions/hide_and_reap_downed
# for the 2nd one we must make sure it only runs AFTER the 1st second. 
# this is because the downed logic requires the player be at 0 hearts but that interfears with the selection of the corrupted
...
execute as @a[team=corrupted] if score @s corruption_stun matches 1.. run title @a title [{"text":":","color":"dark_purple"},{"score":{"name":"@s","objective":"corruption_stun"}},{"text":":","color":"dark_purple"}]
execute as @a[team=corrupted] if score @s corruption_stun matches 0 run title @a title [{"text":":","color":"dark_purple"},{"text":"HES LOOSE","color":"dark_purple"},{"text":":","color":"dark_purple"}]
...
execute as @a[team=runners] if score @s health matches 0 if score hide_and_reap_time playtime matches 0..50 run team join corrupted @s
# if a corrupted one kills a runner, he becomes a runner
# this is done by detecting if they have at least 1 health
# this can only happen at the 1st second
...
#===========================================================================================================================================
# if the one corrupted is above 70%. the engame starts

# check if the corrupted one has 70% corruption, only then can the engame state start

execute if score @a[team=corrupted,limit=1] corruption matches 70.. run function ctnv:endgame
...
scoreboard players operation @a[team=dead] class *= negitive class
scoreboard players set @a[team=dead] evil_class -1

# here we run the function again. so that we can do the actual effects from the victory.
# i know its a bit complicated but it works
execute if score runner_win hide_and_reap_death_trigger matches 1 run function ctnv:alternate_gamemode_functions/hide_and_reap_runner_victory
...
# then trigger it
execute if score gamers players_online matches 1 if entity @a[team=corrupted] run function ctnv:alternate_gamemode_functions/hide_and_reap_corrupted_victory
...
#==================================================================================================
# in most other gamemodes players corruption values are below there name tags. that does not work here
