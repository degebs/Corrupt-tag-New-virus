...
execute as @a[team=runners] run scoreboard players add @a[team=runners] runners_alive 1
scoreboard players operation @a[team=runners] runners_alive = @a[team=runners] runners_alive
