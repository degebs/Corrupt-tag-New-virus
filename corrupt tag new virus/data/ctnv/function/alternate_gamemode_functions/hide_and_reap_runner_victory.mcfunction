...
execute if score tick time matches 3 if score victory_timer victory matches 19 as @a[team=!dead] run tellraw @a ["                 "]
execute if score tick time matches 3 if score victory_timer victory matches 19 as @a[team=!dead] run tellraw @a [{"selector":"@s"}," has survived! "]
