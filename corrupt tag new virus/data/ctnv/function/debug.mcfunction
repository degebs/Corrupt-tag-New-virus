...
execute if score toggle debug matches 1 run give @a written_book[written_book_content={pages:[[["",{"text":"summon lobby beacon","color":"green","click_event":{"action":"run_command","command":"/function ctnv:one_time_function/summon_lobby_beacon"},"hover_event":{"action":"show_text","value":"sets the spawn point basically, there can only be 1 lobby beacon so there is no need to break the previous one"}},"\n\n",{"text":"summon map beacon","color":"dark_green","click_event":{"action":"run_command","command":"/function ctnv:one_time_function/summon_map_beacon"},"hover_event":{"action":"show_text","value":"summons a map beacon. name it with a name tag. make sure the radius is open for players to spawn... take care of the turtle"}},"\n",{"text":"destroy map beacon","color":"dark_red","click_event":{"action":"run_command","command":"/function ctnv:one_time_function/kill_map_beacon"},"hover_event":{"action":"show_text","value":"kills a map beacon if you are near... you monster "}},"\n",{"text":" KILL all beacons","click_event":{"action":"run_command","command":"/function ctnv:one_time_function/destrtoy_all_beaconds"},"hover_event":{"action":"show_text","value":"THIS WILL DESTROY ALL BEACONS!!!!"}}]]],title:"debug book",author:degebs,generation:0}]
