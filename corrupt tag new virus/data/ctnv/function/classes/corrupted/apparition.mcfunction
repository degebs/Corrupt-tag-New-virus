...
execute as @s at @s if entity @a[distance=30..,team=runners] run effect give @s speed 1 1 true
# apply slowness to the runners
execute at @s if entity @a[distance=..3,team=runners] unless score @s corruption matches 90.. run effect give @a[distance=3..5,team=runners] slowness 2 2 true
...
execute if score @s[scores={evil_class=3}] corruption matches 15..50 unless entity @s[nbt={Inventory:[{id:"minecraft:glowstone_dust",Slot:4b}]}] if score @s apparition_corrupted_t2_cooldown matches 0 run scoreboard players set @s apparition_corrupted_t2_cooldown 600

execute if score @s[scores={evil_class=3}] corruption matches 15..50 if score @s apparition_corrupted_t2_cooldown matches 1.. run scoreboard players remove @s apparition_corrupted_t2_cooldown 1
# give the corrupted his vission of all runners
execute if score @s[scores={evil_class=3}] corruption matches 15..50 if score @s[scores={apparition_corrupted_t2_cooldown=599}] apparition_corrupted_t2_cooldown matches 599 run effect give @a[team=runners] glowing 15 1
...
execute if score @s[scores={evil_class=3}] corruption matches 15..50 unless entity @s[nbt={Inventory:[{id:"minecraft:glowstone_dust",Slot:4b}]}] run kill @e[type=item,nbt={Item:{id:"minecraft:glowstone_dust"}}]
execute if score @s[scores={evil_class=3}] corruption matches 15..50 unless entity @s[nbt={Inventory:[{id:"minecraft:glowstone_dust",Slot:4b}]}] if score @s apparition_corrupted_t2_cooldown matches 0 run item replace entity @s hotbar.4 with glowstone_dust[custom_name=[{"text":"reveal players","italic":false,"color":"yellow"}],lore=[[{"text":"drop to reveal players","italic":false}]]]
...
# speed bost item for the rework
# 30 second cooldown when the item is dropped
scoreboard players add @s apparition_speed_boost_cooldown 0
execute if score @s apparition_speed_boost_dectect matches 1 run scoreboard players set @s apparition_speed_boost_cooldown 600
execute if score @s apparition_speed_boost_dectect matches 1 run effect give @s speed 10 4 true
execute if score @s apparition_speed_boost_dectect matches 1 run clear @s sugar
execute if score @s apparition_speed_boost_dectect matches 1 run kill @e[type=item,nbt={Item:{id:"minecraft:sugar"}}]
execute if score @s apparition_speed_boost_dectect matches 1 run playsound entity.skeleton_horse.ambient player @s ~ ~ ~ 1 1 0.5

execute if score @s apparition_speed_boost_cooldown matches 1.. run scoreboard players remove @s apparition_speed_boost_cooldown 1

execute if score @s apparition_speed_boost_cooldown matches 600 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 30
execute if score @s apparition_speed_boost_cooldown matches 599 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 30
execute if score @s apparition_speed_boost_cooldown matches 580 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 29
execute if score @s apparition_speed_boost_cooldown matches 560 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 28
execute if score @s apparition_speed_boost_cooldown matches 540 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 27
execute if score @s apparition_speed_boost_cooldown matches 520 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 26
execute if score @s apparition_speed_boost_cooldown matches 500 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 25
execute if score @s apparition_speed_boost_cooldown matches 480 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 24
execute if score @s apparition_speed_boost_cooldown matches 460 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 23
execute if score @s apparition_speed_boost_cooldown matches 440 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 22
execute if score @s apparition_speed_boost_cooldown matches 420 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 21
execute if score @s apparition_speed_boost_cooldown matches 400 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 20
execute if score @s apparition_speed_boost_cooldown matches 380 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 19
execute if score @s apparition_speed_boost_cooldown matches 360 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 18
execute if score @s apparition_speed_boost_cooldown matches 340 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 17
execute if score @s apparition_speed_boost_cooldown matches 320 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 16
execute if score @s apparition_speed_boost_cooldown matches 300 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 15
execute if score @s apparition_speed_boost_cooldown matches 280 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 14
execute if score @s apparition_speed_boost_cooldown matches 260 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 13
execute if score @s apparition_speed_boost_cooldown matches 240 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 12
execute if score @s apparition_speed_boost_cooldown matches 220 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 11
execute if score @s apparition_speed_boost_cooldown matches 200 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 10
execute if score @s apparition_speed_boost_cooldown matches 180 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 9
execute if score @s apparition_speed_boost_cooldown matches 160 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 8
execute if score @s apparition_speed_boost_cooldown matches 140 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 7
execute if score @s apparition_speed_boost_cooldown matches 120 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 6
execute if score @s apparition_speed_boost_cooldown matches 100 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 5
execute if score @s apparition_speed_boost_cooldown matches 80 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 4
execute if score @s apparition_speed_boost_cooldown matches 60 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 3
execute if score @s apparition_speed_boost_cooldown matches 40 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 2
execute if score @s apparition_speed_boost_cooldown matches 20 run item replace entity @s hotbar.4 with gray_dye[custom_name=[{"text":"speed boost cooldown","italic":false}]] 1

execute if score @s apparition_speed_boost_cooldown matches 0 if score @s corruption matches 50.. run item replace entity @s hotbar.4 with sugar[custom_name=[{"text":"speed boost","italic":false,"color":"yellow"}],lore=[[{"text":"drop to gain speed boost","italic":false}]]]

execute if score @s apparition_speed_boost_dectect matches 1 run scoreboard players set @s apparition_speed_boost_dectect 0
