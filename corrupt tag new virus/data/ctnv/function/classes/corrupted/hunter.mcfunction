...
execute if score @s corruption matches 80.. run effect give @s speed 1 2 true
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# tier 3 trap
# When the player drops the trap, start a cooldown (20s = 400 ticks), and remove the item
execute if score @s corruption matches 80.. unless entity @s[nbt={Inventory:[{Slot:6b,id:"minecraft:ominous_trial_key"}]}] if score @s hunter_corrupted_t3_trap matches 0 run scoreboard players set @s hunter_corrupted_t3_trap 400

# give the hunter a trap item, make sure he cannot drop it
# Give the hunter a trap item in hotbar slot 6 if they don't already have it and are at least 80% corrupt
execute if score @s corruption matches 80.. unless data entity @s Inventory[{Slot:6b,id:"minecraft:ominous_trial_key"}] run kill @e[type=item,nbt={Item:{id:"minecraft:ominous_trial_key"}}]
execute if score @s corruption matches 80.. unless data entity @s Inventory[{Slot:6b,id:"minecraft:ominous_trial_key"}] if score @s hunter_corrupted_t3_trap matches 0 run item replace entity @s hotbar.6 with ominous_trial_key[custom_name=[{"text":"Hunter Corrupter Hawk","italic":false,"color":"dark_purple"}],lore=[[{"text":"drop to place a trap","italic":false}]]]
...
# When cooldown is over, give the trap back if missing
execute if score @s corruption matches 80.. if score @s hunter_corrupted_t3_trap matches 0 unless entity @s[nbt={Inventory:[{id:"minecraft:ominous_trial_key",Slot:6b}]}] run item replace entity @s hotbar.6 with ominous_trial_key[custom_name=[{"text":"Hunter Corrupter Hawk","italic":false,"color":"dark_purple"}],lore=[[{"text":"drop to place a trap","italic":false}]]]
