...
execute if score setting ST____class_selection matches 1 if score @s select_singularity matches 1 run scoreboard players set enable select_singularity 0
execute if score setting ST____class_selection matches 1 if score @s select_singularity matches 1 run tellraw @a [{"text":"[x] ","color":"red","bold":true},{"text":"Singularity","color":"dark_purple","bold":true},{"text":" will be disabled!","color":"gray"}]
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# reset when done
