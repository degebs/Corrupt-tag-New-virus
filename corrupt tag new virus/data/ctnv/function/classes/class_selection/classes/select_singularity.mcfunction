# setup
scoreboard objectives add select_Fracturizer minecraft.dropped:silence_armor_trim_smithing_template
...
execute if items entity @s player.cursor silence_armor_trim_smithing_template run scoreboard players set @s select_Fracturizer 1
...
execute if score @s select_Fracturizer matches 1 run clear @s silence_armor_trim_smithing_template
execute if score @s select_Fracturizer matches 1 run kill @e[type=item,nbt={Item:{id:"minecraft:silence_armor_trim_smithing_template"}}]
# selection
execute if score @s select_Fracturizer matches 1 run scoreboard players set @s evil_class 12
execute if score @s select_Fracturizer matches 1 run tellraw @a [{"color":"gold","selector":"@s"}," ",{"text":"picked the","color":"white"}," ",{"text":"Singularity","color":"dark_purple"}," ",{"text":"Corrupted class","color":"white"}]
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# reset when done
scoreboard players set @s select_Fracturizer 0
