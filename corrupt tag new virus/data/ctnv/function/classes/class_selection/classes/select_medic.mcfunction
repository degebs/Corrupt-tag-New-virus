...
execute if score @s select_medic matches 1 run tellraw @a [{"color":"gold","selector":"@s"}," ",{"text":"picked the","color":"white"}," ",{"text":"Medic","color":"dark_aqua"}," ",{"text":"class","color":"white"}]
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#reset when done
scoreboard players set @s select_medic 0
