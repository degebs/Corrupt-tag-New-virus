...
execute if score setting ST____class_selection matches 1 if score @s select_authority matches 1 run scoreboard players set enable select_authority 0
execute if score setting ST____class_selection matches 1 if score @s select_authority matches 1 run tellraw @a [{"text":"[x] ","color":"red","bold":true},{"text":"Authority","color":"dark_purple","bold":true},{"text":" will be disabled!","color":"gray"}]
