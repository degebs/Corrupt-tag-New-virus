...
execute if score @s select_Fracturizer matches 1 run tellraw @a [{"color":"gold","selector":"@s"}," ",{"text":"picked the","color":"white"}," ",{"text":"Fracturizer","color":"dark_purple"}," ",{"text":"Corrupted class","color":"white"}]
