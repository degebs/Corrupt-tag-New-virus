...
execute if score setting ST____class_selection matches 1 if score @s select_assassin matches 1 run scoreboard players set enable select_assassin 0
execute if score setting ST____class_selection matches 1 if score @s select_assassin matches 1 run tellraw @a [{"text":"[x] ","color":"red","bold":true},{"text":"Assassin","color":"dark_aqua","bold":true},{"text":" will be disabled!","color":"gray"}]
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# reset when done
