...
execute unless score game state matches 0 if score @s select_manhunter matches 1 run tellraw @a [{"color":"gold","selector":"@s"}," ",{"text":"picked the","color":"white"}," ",{"text":"Manhunter","color":"dark_purple"}," ",{"text":"Corrupted class","color":"white"}]
...
execute if score setting ST____class_selection matches 1 if score @s select_manhunter matches 1 run scoreboard players set enable select_manhunter 0
execute if score setting ST____class_selection matches 1 if score @s select_manhunter matches 1 run tellraw @a [{"text":"[x] ","color":"red","bold":true},{"text":"Manhunter","color":"dark_purple","bold":true},{"text":" will be disabled!","color":"gray"}]

#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# reset when done
# we must make it so that it does not reset during pregame
execute unless score game state matches 0 run scoreboard players set @s select_manhunter 0
