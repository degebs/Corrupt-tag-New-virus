...
execute unless score game state matches 0 if score @s select_dark_star matches 1 run tellraw @a [{"color":"gold","selector":"@s"}," ",{"text":"picked the","color":"white"}," ",{"text":"DARK Star","color":"dark_purple"}," ",{"text":"Corrupted class","color":"white"}]
