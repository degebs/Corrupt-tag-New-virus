...
execute unless entity @s[nbt={Inventory:[{id:"minecraft:bow",Slot:0b}]}] run item replace entity @s hotbar.0 with bow[custom_name=[{"text":"Odysseus","italic":false}],enchantments={punch:2,unbreaking:255}]
