...
execute as @a if score countdown time matches ..28 unless entity @s[nbt={Inventory:[{id:"minecraft:tnt",Slot:31b}]}] run tellraw @a [{"color":"gold","selector":"@s"}," ",{"text":"picked the","color":"white"}," ",{"text":"Hunter","color":"dark_purple"}," ",{"text":"Corrupted class","color":"white"}]
